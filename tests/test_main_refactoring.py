...
class TestGetDataAsArray:
    """Tests the internal _get_data_as_array helper method."""
    ...
    def test_wrong_data_type_for_aspect(self, grapher, sample_dict_data, sample_array_data):
        ...
        grapher.aspect = "dict"
        # This should work, as it allows arrays for dict aspect
        result = grapher._get_data_as_array(sample_array_data)
        np.testing.assert_array_equal(result, sample_array_data)
